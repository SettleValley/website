        ...
        <div className="col-md-6">
          ...
          <h2 className="font-weight-bold text-uppercase title-2">Creating and Building Creative Idea.</h2>
            <p>
              ...
              Trying to think new ideas that can improve and optimize some process in the industry, 
              It's funny because not every ideas are good but some are. In my free time I spend my time on youtube watching Platzi News or Netflix series. 
